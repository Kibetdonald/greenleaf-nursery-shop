...
<label for="inputState">Product Variety</label>
   <select class="custom-select" name="prd_variety" required>
          ...
          while($row_subs=mysqli_fetch_array($run_subs)){
               ...
               echo "<option value = $variety_id > $variety_title </option>";    
...
if(isset($_POST['index'])){
   ...
   $insert_product = "insert into products (prd_cat,prd_variety,prd_title,prd_price,prd_desc,prd_img,prd_keyword,prd_quantity) values ('$prd_cat','$prd_variety','$prd_title','$prd_price','$prd_desc','$prd_img','$prd_keyword','$prd_quantity')";
