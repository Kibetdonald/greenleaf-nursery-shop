...
//updating the table
mysqli_query($con,"UPDATE farmer SET username='$username', phone='$phone', Email_Id='$Email_Id', password='$password' WHERE farmer_id='$id'");
...
echo"<script>window.open('manage_users.php?tn=$r','_self')</script>";
...
$id = $_GET['id'];
$result = mysqli_query($con,"SELECT * FROM farmer WHERE farmer_id=".$_GET['id']);
...
<!-- end of main_container -->
    ...
    <input type="hidden" name="id" value="<?php echo $id; ?>"/>
	 ...
	 <div class="form-group">
        ...
        <div class="form-group">
		<div class="col-sm-8">
			<button type="button" name="cancel" value="cancel" id="cancel" onClick="window.location='manage_users.php';" class="btn btn-primary">Cancel</button>
		</div>
		<div class="col-sm-4">
